            ...
            <div class="card card-primary card-outline">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title"><strong>Data RAB Material Unit Rumah</strong></div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="table-id" class="table table-bordered table-striped" style="font-size:15px;">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($rabmatbyunit as $c) : ?>
                                        <?php $sumprice = $c['sum_rab'] ?>
                                        <?php $sumpakeprice = $c['sum_pake_rab'] ?>
                                        <tr>
                                            <td><?php echo $i++; ?></td>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url('rabmaterialbyunit/detailrab/' . $c['id_unit']); ?>" class="btn btn-sm btn-primary"><i class="fas fa-eye"></i> Detail</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
