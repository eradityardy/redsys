            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <div class="float-left">
                        <div class="card-title"><strong>Detail RAB Pekerjaan</strong> - <i><?php echo $typerum['nama_type'] ?></i></div>
                    </div>
                    <div class="float-right">
                        ...
                        <a href="<?php echo base_url('index.php/rabpekerjaanbytype/') ?>" class="btn btn-sm btn-warning">Kembali</a>
                    </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($detailrab as $c) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('rabpekerjaanbytype/hapusrab/'.$type_id.'/'.$c['id_rpbt']); ?>" class="tombol-hapus btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="<?php echo base_url('rabpekerjaanbytype/detailrab/'.$type_id); ?>" method="post" class="form-horizontal">
