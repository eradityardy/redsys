                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url() ?>bookingrumah/simpanbooking" method="post" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-6">
                                            ...
                                            echo"</select>" ?>
                                            <input type="hidden" name="unitrumah_id" id="unit_id" value="">
                                        </div>
                                        <div class="col col-md-6">
                                            <label for="customer_id_nama">Customer</label>
                                            <input type="hidden" name="customer_id" id="customer_id" value="">
                                            <input type="text" name="customer_id_nama" id="customer_id_nama" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-4">
                                            <label for="tgl_berkaskebank">Serah Berkas ke Bank</label>
                                            <input type="date" id="tgl_berkaskebank" name="tgl_berkaskebank" class="form-control">
                                        </div>
                                        <div class="col col-md-4">
                                            <label for="tgl_akad">Akad</label>
                                            <input type="date" id="tgl_akad" name="tgl_akad" class="form-control">
                                        </div>
                                        <div class="col col-md-4">
                                            <label for="tgl_berkastolak">Berkas Ditolak</label>
                                            <input type="date" id="tgl_berkastolak" name="tgl_berkastolak" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-12">
                                            <label for="alasan_tolak" class="form-control-label">Alasan Ditolak</label>
                                            <textarea name="alasan_tolak" id="alasan_tolak" rows="2" class="form-control"></textarea>
                                        </div>
                                    </div>
