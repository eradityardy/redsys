                    ...
                    <div class="card card-primary card-outline">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title"><strong>Edit Opname Progress</strong></div>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url() ?>opnameprogress/updateprogress" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                        <input type="hidden" name="id_op" value="<?php echo $id_op ?>">
                                        <div class="col col-md-6">
                                            <label for="tgl_progress">Tanggal Pengerjaan</label>
                                            <input type="date" id="tgl_progress" name="tgl_progress" class="form-control" value="<?php echo $tgl_progress ?>" required>
                                        </div>
                                        <div class="col col-md-6">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" id="persentase" name="persentase" class="form-control" min="0" max="100" value="<?php echo $persentase ?>" required>
                                                </td>
                                                <td>
                                                    <input type="number" id="price" name="price" class="form-control" value="<?php echo $price ?>" Readonly>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <div class="form-group">
                                        ...
                                        <div class="float-left">
                                            <input type="submit" name="updateprogress" class="btn btn-primary" value="Update">
                                        </div>
                                    </div>
                                </form>
                            </div>
