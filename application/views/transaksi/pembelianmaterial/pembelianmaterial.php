            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <a type="button" href="<?php echo base_url('transaksipembelian/exportexcel'); ?>" class="btn btn-sm bg-maroon">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="btn-group-vertical">
                                                ...
                                                <a href="<?php echo base_url('transaksipembelian/hapuspembelian/'.$t['id_tbm'].'/'.$t['no_faktur']); ?>" class="tombol-hapus btn btn-sm btn-danger">
